    ...
    return (
        <div className={styles.homeContainer}>
            <header className={styles.navbar}>
                <div className={styles.logo}>PURRS</div>
                ...
                <section className={styles.supportSection}>
                    ...
                    <div className={styles.supportOptions}>
                        <div className={styles.supportOption}>
                            ...
                            <a href="#learn-more1" className={styles.learnMore}>Learn More</a>
                        </div>
                        <div className={styles.supportOption}>
                            <div className={styles.imagePlaceholder}></div>
                            <h3>Found a stray cat? Let us know. We can help you.</h3>
                            <a href="#learn-more2" className={styles.learnMore}>Learn More</a>
                        </div>
                        <div className={styles.supportOption}>
                            <div className={styles.imagePlaceholder}></div>
                            <h3>Support hospitals for TNR (Trap-Neuter-Return) Programs</h3>
                            <a href="#learn-more3" className={styles.learnMore}>Learn More</a>
                        </div>
                    </div>
                </section>
            </main>
